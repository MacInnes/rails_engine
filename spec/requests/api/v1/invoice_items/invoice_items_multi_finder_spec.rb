...
describe 'Invoice Items Multi Finder API' do
  context 'GET /api/v1/invoice_items/find_all?paramaters' do
    ...
    it 'returns all invoice items by created_at' do
      ...
      create_list(:invoice_item, 3, created_at: valid_created_at)
      create_list(:invoice_item, 3, created_at: invalid_created_at)

      get "/api/v1/invoice_items/find_all?created_at=#{valid_created_at}"
    ...
    it 'returns all invoice items by updated at' do
      ...
      create_list(:invoice_item, 3, updated_at: valid_updated_at)
      create_list(:invoice_item, 3, updated_at: invalid_updated_at)

      get "/api/v1/invoice_items/find_all?updated_at=#{valid_updated_at}"
